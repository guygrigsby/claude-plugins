...
5. **Dispatch the selected reviewers with the artifact.**
...
6. **Collect verdicts, compute concordance and slop score.**
   - **Concordance**: percentage of findings where 2+ structured reviewers agree.
   - **Slop score**: average slop score across structured reviewers (exclude ODB from this calculation).
