...
- **[drift-guards](plugins/drift-guards/CLAUDE.md)** -- every fact that lives in two places gets a test comparing them (registry/table, hash freeze, executable examples, path existence, determinism), wired into the project's default gate
